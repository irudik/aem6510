...
$\delta$ is the discontinuity in the conditional expectation function:
\begin{align}
...
The sharp RDD gives us an average causal effect of treatment *at the discontinuity*, which is why it is called a local average treatment effect (LATE):
...
This is likely reasonable: the borders were arbitrarily set in 1750 when the area was virtually unexplored: where the border is *locally* is almost random
...
How do you even *do* something like this with data on forest cover?
