...
Now lets see how this works in practice: [notebook here](https://raw.githack.com/irudik/aem6510/master/lecture-notes/12-health-dd/12-health-dd-notebook.html)
...
With an event study we can see how the effect changes *over time*
...
Now lets use the actual HR (2021) data to get some practice: [notebook here](https://raw.githack.com/irudik/aem6510/master/lecture-notes/12-health-dd/12-health-dd-notebook.html)
