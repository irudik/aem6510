...
hedonic_p <- function(x) -x^2/2.2 + 4*x + 1.
ggplot() +
  ...
  stat_function(fun = hedonic_p, color = "#ca5670", size = 1.0) +
    annotate("segment", x = 1.3, xend = 1.3, y = 0, yend = 5.25,
           linetype = "dotted", size = 1, color = "grey55") +
    annotate("segment", x = .5, xend = .5, y = 0, yend = 2.5,
           linetype = "dotted", size = 1, color = "grey55") +
    annotate("segment", x = 0, xend = 1.3, y = 5.25, yend = 5.25,
           linetype = "dotted", size = 1, color = "grey55") +
  annotate("text", size = 6, label = expression(b(x,q,y,s, u^2)), x = 3.25, y = 14, color = "#638ccc") +
  annotate("text", size = 6, label = expression(b(x,q,y,s, u^0)), x = 3.25, y = 11, color = "#638ccc") +
  annotate("text", size = 6, label = expression(b(x,q,y,s, u^1)), x = 3.25, y = 5, color = "638ccc") +
  annotate("text", size = 6, label = "P(x,q)", x = 3.25, y = 8.5, color = "#ca5670") +
  annotate("text", size = 6, label = "a", x = 1.25, y = 6, color = "black") +
  theme_minimal() +
  theme(
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 15), breaks = c(5.25), labels = expression(P(x,q[0]))) +
  labs(x = "q",
       y = "$",
