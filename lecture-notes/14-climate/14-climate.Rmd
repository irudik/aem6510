---
title: "Lecture 14"
subtitle: "Climate // Identification, Ricardian, Two Way FEs, Integrated Assessment"
author: Ivan Rudik
date: AEM 6510
output:
...
knitr::include_graphics("figures/14-paleoclimate.png")
```
</div>
...
.hi-blue[General circulation models] popped up in the 1960s using fluid dynamics
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-detection.png")
```
</div>
...
Detection is where we need to determine if there has been a change in climate, attribution is figuring out what caused it
...
When trying to determine human causes, we need to simulate counterfactual climates without human influence
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-model_vs_obs.png")
```
</div>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-projected_temp.png")
```
</div>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-us_rcp85.png")
```
</div>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-flooding.png")
```
</div>
...
\begin{align}
  \frac{dY(\mathbf{C})}{d\mathbf{C}} = \sum_{k=1}^K \frac{\partial Y(\mathbf{C})}{\partial \mathbf{c}_k} \cdot \frac{d\mathbf{c}_k}{d\mathbf{C}}   + \sum_{n=1}^N\frac{\partial Y(\mathbf{C})}{\partial \mathbf{b}_n} \frac{d\mathbf{b}_n}{d\mathbf{C}}
\end{align}
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-value_of_farmland.png")
```
</div>
...
knitr::include_graphics("figures/14-ricardian_table_1.png")
```
</center>
...
<center>
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-ricardian_figure_1.png")
```
</center>
...
<center>
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-ricardian_figure_2.png")
```
</center>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-ricardian_figure_3.png")
```
</div>
...
knitr::include_graphics("figures/14-ricardian_table_2.png")
```
</center>
...
knitr::include_graphics("figures/14-ariel_1.png")
```
</div>
...
knitr::include_graphics("figures/14-ariel_2.png")
```
</div>
...
<center>
```{r, out.width = "700px", echo = FALSE}
knitr::include_graphics("figures/14-dg_1.png")
```
</center>
...
<center>
```{r, out.width = "600px", echo = FALSE}
knitr::include_graphics("figures/14-dg_2.png")
```
</center>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-dg_3.png")
```
</div>
...
<div style= "float:right;position: relative;">
```{r, out.width = "575px", echo = FALSE}
knitr::include_graphics("figures/14-dh_1.png")
```
</div>
...
knitr::include_graphics("figures/14-iam_1.png")
```
</center>
