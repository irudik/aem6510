...
$$u_XX {\partial X \over \partial \tau} + u_{XN}{\partial N \over \partial \tau} = {\partial p \over \partial \tau} \tag{Household X FOC}$$


$$u_XN {\partial X \over \partial \tau} + u_{N}{\partial N \over \partial \tau} = 0 \tag{N FOC}$$
