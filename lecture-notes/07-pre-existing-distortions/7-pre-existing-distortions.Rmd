...
- demand for for dirty good is sufficiently inelastic
...
.hi-blue[Demand for for dirty good is sufficiently inelastic]:
...
Is there a prospect for a double dividend?
...
Price of $X$ rises from $\tau$, demand for leisure goes down, labor supply goes up
...
Suppose N and X are *average subsitutes* so that $\eta_{XN} = \varepsilon_L$, then:
