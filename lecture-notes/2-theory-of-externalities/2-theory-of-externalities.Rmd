...
$$\max_{x_1,x_2,z_1,z_2,l_x,l_z,E} U_1(x_1,z_1,E) \\+ \lambda_u[U_2(x_2,z_2,E) - \bar{u}_2] \\+ \lambda_x[f(l_x,E) - x_1 - x_2] \\+ \lambda_z[g(l_x) - z_1-z_2] \\+ \lambda_l[l - l_x - l_z]$$
...
= \lambda_x/\lambda_z 
= {\partial g \over \partial l_z}\Bigg/{\partial f \over \partial l_x} \equiv MRT$$
...
- Ann is willing to give up 2 units of $x$ for 1 more unit of $z$
- Bob is willing to give up 4 units of $x$ for 1 more unit of $z$
  
If Bob gives Ann 3 units of $x$ in exchange for $1$ unit of z, .b[both are better off]

Bob was willing to give up 4 units, Ann was willing to accept 2 units
  
]
  
.panel[.panel-name[Exchange Efficiency]

Suppose MRS is 1 and MRT is 3, the MRS and MRT tell us that:
