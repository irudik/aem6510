...
They are necessary but not sufficient: you can come up with counter-examples where a function's derivative equals zero but it is not maximized ( e.g. $x^3$ )
...
We have one remaining issue: some arbitrary $\lambda$ won't guarantee that the solution of our Lagrangian will match the actual constrainted problem

--

We need to find a way to pick the correct $\lambda^*$ that incentivizes the agent to exactly satisfy the constraint $h(x_1,x_2) = a$
